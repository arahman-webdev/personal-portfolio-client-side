...
const BlogCard = () => {
  return (
    <>
      <div className="group">
        <div className="border border-slate-200 bg-white rounded-2xl overflow-hidden group-hover:-translate-y-1.5 transition-all duration-200 ease-in hover:shadow-2xl">
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="space-y-3">
              <h2 className="text-[#343D55] font-semibold text-2xl group-hover:bg-gradient-to-r from-[#8236fb] to-[#076ef4] group-hover:text-transparent group-hover:bg-clip-text">Spotlight — Equinox Collection by Shane Griffin</h2>
              <p className="text-[#697582] text-base leading-relaxed line-clamp-3">Looking for inspiration to kick it off, I stumbled across the work of Shane Griffin, an artist and director based in New YorkLooking for inspiration to kick it off, I stumbled across the work of Shane Griffin, an artist and director based in New York</p>
            </div>
            <div>
              <Link href={'/'}
                className="inline-flex gap-2 items-center bg-gradient-to-r from-[#8236fb] to-[#076ef4] bg-clip-text text-transparent font-medium"
              >
                Read More →
              </Link>
