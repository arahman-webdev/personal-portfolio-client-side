                ...
                <div className="container mx-auto text-white">
                  ...
                  <div className="py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-x-8 gap-y-10 px-6 xl:px-0">
                    ...
                    <div className="col-span-full lg:col-span-2">
                      <h4 className="text-2xl md:text-3xl lg:text-4xl font-bold">ABOUT ME</h4>
                      <div className="bg-linear-to-r from-[#e2064f]  w-32 md:w-64 h-[2px]"></div>
                      <p className="mt-4 text-white text-sm md:text-base">
                        Hello! I&apos;m a passionate and results-driven software developer with expertise in modern web technologies. My focus is on creating clean, efficient, and user-friendly applicationsthat solve real-world problems.
                      </p>
                    ...
                    <div>
                      <h6>Contact</h6>
                      <p>5840 Sherpur Road. Bogra, Bangladesh</p>
                      <span>Need help? Call us</span>
                      <span>+(880) 1719-617907</span>
                      <span>mdarahman5645@gmail.com</span>
                    </div>
                  </div>
